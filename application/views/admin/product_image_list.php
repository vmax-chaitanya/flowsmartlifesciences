                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-2 ms-auto">
                                    <a href="<?php echo base_url(); ?>admin/product/image/create/<?php echo $id; ?>"
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($product_images as $image): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url('admin/product/image/edit' . $image['id']); ?>"
                                                                class="btn btn-outline-primary">Edit</a>
                                                            <a href="<?php echo base_url('admin/product/image/delete/' . $image['id']); ?>"
